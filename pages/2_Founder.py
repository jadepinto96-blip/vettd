...
<div style="display:flex;align-items:flex-start;gap:2rem;margin-bottom:2rem;background:var(--bg-base);border:1px solid var(--border);border-radius:24px;padding:2rem;">
...
<div style="font-size:12px;color:var(--text-3);margin-top:10px;">Mumbai, India</div>
</div>
<div>
<div style="font-size:21px;font-weight:700;color:var(--text-1);margin-bottom:4px;">Jade Pinto</div>
...
<div style="background:var(--bg-base);border:1px solid var(--border);border-radius:16px;padding:1.5rem;text-align:center;">
...
<div style="font-size:12px;color:var(--text-3);margin-top:4px;">followers in 5 months</div>
</div>
<div style="background:var(--bg-base);border:1px solid var(--border);border-radius:16px;padding:1.5rem;text-align:center;">
...
<div style="font-size:12px;color:var(--text-3);margin-top:4px;">clients advised in consulting</div>
</div>
<div style="background:var(--bg-base);border:1px solid var(--border);border-radius:16px;padding:1.5rem;text-align:center;">
...
<div style="font-size:12px;color:var(--text-3);margin-top:4px;">Champion of the Quarter</div>
</div>
</div>

<div style="display:flex;flex-direction:column;gap:1.5rem;margin-bottom:3rem;">

<div style="background:var(--bg-base);border:1px solid var(--border);border-radius:18px;padding:1.75rem;">
...
<div style="background:var(--bg-base);border:1px solid rgba(124,58,237,.3);border-radius:18px;padding:1.75rem;position:relative;overflow:hidden;">
...
<p style="font-size:15px;color:var(--text-2);line-height:1.9;margin:0;">Then she crossed to the other side. Creating content on motivation and the way people think and behave, Jade grew her own page <b style="color:var(--text-1);">from 0 to 75,000 followers in just five months</b>. Living the creator journey herself showed her exactly how brands evaluate creators — and how often great, well-matched creators get overlooked while the numbers tell only half the story.</p>
</div>
...
<div style="font-size:12px;color:var(--text-4);margin-top:14px;">— Jade Pinto, Founder of Vettd</div>
</div>
