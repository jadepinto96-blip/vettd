...
st.markdown("""
<div style="font-family:'Inter',sans-serif;background:#050509;color:#EDEDF5;min-height:100vh;">
...
<div style="background:rgba(124,58,237,.06);border:1px solid rgba(124,58,237,.2);border-radius:20px;padding:1.75rem;">
...
<div style="background:rgba(34,211,238,.06);border:1px solid rgba(34,211,238,.2);border-radius:20px;padding:1.75rem;">
...
<div style="background:rgba(167,139,250,.06);border:1px solid rgba(167,139,250,.2);border-radius:20px;padding:1.75rem;">
...
<div style="background:rgba(79,70,229,.06);border:1px solid rgba(79,70,229,.2);border-radius:20px;padding:1.75rem;">
...
<div style="font-size:11px;font-weight:700;letter-spacing:.15em;text-transform:uppercase;color:#3A3A52;margin-bottom:1.5rem;">How the Vettd Score works</div>
...
for name, weight, desc, color in score_components:
    st.markdown(f"""<div style="display:flex;align-items:flex-start;gap:1rem;background:#0A0A14;border:1px solid #14142A;border-radius:14px;padding:1.25rem;">
<div style="min-width:52px;height:52px;border-radius:12px;background:linear-gradient(135deg,{color}22,{color}11);border:1px solid {color}44;display:flex;align-items:center;justify-content:center;font-size:15px;font-weight:800;color:{color};">{weight}</div>
